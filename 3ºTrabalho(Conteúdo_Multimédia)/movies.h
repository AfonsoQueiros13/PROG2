...
/**
 * Remove um cliente da colecaoClientes (tabela de dispersao)
 * parametros: apontador para colecaoClientes, username do cliente a remover
 * retorno: -1 se erro, 0 se o username nao consta na tabela, 1 se foi removido
 */
 ...
 * parametro: apontador para a estrutura colecaoFilmes, apontador para a estrutura colecaoClientes , titulo do filme, c
 ...
 * parametros: apontador para colecaoFilmes a apagar
 */
